...
import Header from "../../components/katespade.es.com/BreadCrumbs";
import {
  ...
  TEMP_SETTINGS,
  getSearchProvider,
} from "../../components/config/katespade.es.com/globalConfig";
import {
  AnalyticsProvider,
  AnalyticsScopeProvider,
} from "@yext/pages/components";
import Banner from "../../components/locationDetails/LocatorBanner";
import { BaseUrl } from "../../components/config/katespade.es.com/globalConfig";
import { JsonLd } from "react-schemaorg";
import Footer from "../../components/Layout/footer";
import SearchLayout from "../../components/locatorPage/katespade.es.com/SearchLayout";
...
export const config: TemplateConfig = {
  stream: {
    $id: "locatorSearch",
    filter: {
      entityIds: ["katespade-es-site-entity"],
    },
    fields: [
      "name",
      "id",
